...
def test_circle_perimeter_and_area():   #test correct calculation for a valid circle
...
def test_circle_missing_data():   #test error when entering incomplete data
...
def test_circle_invalid_coords():   #test error when entering invalid coordinates
...
def test_circle_invalid_radius():   #test errors when entering invalid radius
...
def test_circle_additional_validation_check():   #test error when entering invalid coordinates (additional check in constructor)
    with pytest.raises(ValueError, match="Radius must be positive"):
